          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Accédez à votre compte pour découvrir Saint-Louis
              </p>
            </div>
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    to="/forgot-password" 
                    className="text-sm text-primary-orange hover:text-orange-600 font-medium transition-colors duration-300"
                  >
                    Mot de passe oublié ?
                  </Link>
                </div>
